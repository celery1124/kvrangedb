...
DB_SRCS=$(HOME)/src/kv_index_lsm.cc $(HOME)/src/kv_index_rocks.cc $(HOME)/src/kv_index_btree.cc $(HOME)/src/kv_index_base.cc $(HOME)/src/kv_index_inmem.cc $(HOME)/src/db_impl.cc $(HOME)/src/db_iter.cc $(HOME)/src/hash.cc $(HOME)/src/filter.cc $(HOME)/src/cache/sharded_cache.cc  $(HOME)/src/cache/lru_cache.cc $(HOME)/src/cache/wlfu_cache.cc $(HOME)/src/cache/fifo_cache.cc
